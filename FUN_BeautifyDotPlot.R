BeautifyDotPlot <- function(scRNA.SeuObj, Path = PathCellType,
                            ...
                            classSet1 = ClassSet1, classSet2 = ClassSet2, classSet3 = ClassSet3){
