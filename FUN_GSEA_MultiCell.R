FUN_GSEA_MultiCell <- function(ranks,Pathway.all,TopNum) {
  ...
  write.table(GSEA_Large.Sum.TOP, file=paste0(Save.Path, "/",PathGSEA,"/",PathGSEA,"_Pathway_LargeTOP_SPA.txt"),sep="\t",
